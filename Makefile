...
run: build
	opam exec -- dune exec -- dsbs -logging=1 test/Main.v
...
debug: build
	opam exec -- ocamldebug _build/default/dsbs/main.bc

DOCS_PATH=docs/
DOCS_NAME=dsbs
DOCS_DESCR=Dead Simple Build System for Coq
...
<meta content="https://github.com/CharlesAverill/dsbs" property="og:url" />
endef
...
docs: cleandocs build
	...
	mv $(DOCS_PATH)dsbs/dsbs.html $(DOCS_PATH)index.html
	mv $(DOCS_PATH)dsbs $(DOCS_PATH)module
